...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn("scroller relative z-20 w-full h-[50vh] md:h-[70vh] overflow-hidden", className)}
    >
      <ul
        ref={scrollerRef}
        className={cn(
          "flex w-full h-full min-w-full shrink-0 flex-nowrap gap-6 py-4",
      ...
      >
        {items.map((item) => (
          <li key={item.id} className="relative w-[80vw] md:w-[30vw] h-full shrink-0 px-2">
            <img
